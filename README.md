...
`7a09292cd518186e0def758c823c0841ee1cacf1` (same Hub pin as Foundation above).
...
`7a09292cd518186e0def758c823c0841ee1cacf1` and Core worker
`8fce2041b9fe742cb2a6df9e74cb262606672742` into a fresh target directory,
then:
...
export BOTSTER_HUB_BIN_REV=7a09292cd518186e0def758c823c0841ee1cacf1
export BOTSTER_SESSION_WORKER_BIN_REV=8fce2041b9fe742cb2a6df9e74cb262606672742
...
- Pins: Hub crates `7a09292cd518186e0def758c823c0841ee1cacf1`, Core crates
  `8fce2041b9fe742cb2a6df9e74cb262606672742`, Ghostty
...
```sh
# Use Hub 7a09292 and Core 8fce204 binaries (same pins as Foundation).
